...
function f.hideOverlay()
	...
	welcomeFrame:TweenPosition(UDim2.new(0.5,-250,0,-350), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, BrandConfig.Motion.Normal, true)
	task.delay(BrandConfig.Motion.Normal + 0.02, function()
...
function f.applyBaseTheme()
	...
	topMenuViewButton.Size = UDim2.new(0,294,0,36)
